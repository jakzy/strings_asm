.model medium
public  items,fn,ibuf,obuf,msg,frm,qws,inp,bye,n, reps, array
    .data
...
n   dw 0 ;num of repeats 
reps db 27 dup('$') ;array of met symbols
array db 27 dup (0) ;counters for each met symbol
    end